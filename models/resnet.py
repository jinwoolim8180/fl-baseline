...
class ResNet(nn.Module):
    def __init__(self, args, block, num_blocks):
        ...
        self.in_planes = 64
        self.conv1 = nn.Conv2d(args.n_channels, 64, kernel_size=3,
                               stride=1, padding=1, bias=False)
        ...
        self.linear = nn.Linear(512 * block.expansion, args.n_classes)
...
resnets = {'resnet18': ResNet18, 'resnet34': ResNet34, 'resnet50': ResNet50, 'resnet101': ResNet101, 'resnet152': ResNet152}